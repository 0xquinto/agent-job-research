...
4. Run: `claude mcp add --transport http exa "https://mcp.exa.ai/mcp?exaApiKey=USER_KEY&tools=web_search_exa,web_search_advanced_exa,get_code_context_exa,crawling_exa"` (replace USER_KEY with the key they pasted)

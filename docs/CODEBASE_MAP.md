---
last_mapped: 2026-04-08T21:00:00Z
total_files: 90
total_tokens: 135045
---
...
> Auto-generated by Cartographer. Last mapped: 2026-04-08
...
## Recent Changes (auto-synced 2026-04-08)

**47 files changed** since last sync.

- **context_files**: 2 files (CLAUDE.md, CODEBASE_MAP.md)
- **docs**: 24 files (CLAUDE.md, applier-2.md, composer-4.md, discoverer-6.md, lead-0.md...)
- **source**: 3 files (tracker.py, test_tracker.py, test_wizard.py)
- **tests**: 2 files (test_tracker.py, test_wizard.py)
